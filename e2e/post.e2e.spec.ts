...
test.describe('Post - E2E', () => {
  test('「他の記事も読む」セクションを検証', async ({ page }) => {
    ...
    expect(link1).toHaveAttribute('href', '/posts/2099/01/04_buff-test')
    ...
    expect(link2).toHaveAttribute('href', '/posts/2099/01/03_tag-test')
    ...
    expect(link3).toHaveAttribute('href', '/posts/2099/01/02_custom-component-test')
  })
